...
<html lang="en">
<head>
<title>Node Health History Graph | Graphs</title>
<meta charset="utf-8">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Node Health History Graph</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Node Health History Graph</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
												...
												<div class="form-group" id="date_div">
													...
													<div class="input-group">
														...
														<input type="text" id='from_date' name='from_date'
															class="form-control" readonly /> <input type="text" id='to_date'
...
<div class="card card-default" id="graphView" style="display: none">
			<div class="card-header">
				<h3 class="card-title">
					Node Health History Graph : <span
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/nodeHealthHistoryGraph.js"></script>
		
	<script
		src="<%=request.getContextPath()%>/webtemplate/plugins/inputmask/jquery.inputmask.min.js"></script>
		<script
		src="<%=request.getContextPath()%>/webtemplate/js/highstock.js"></script>
