...
<html lang="en">
<head>
<title>Node Availability Graph | Graphs</title>
<meta charset="utf-8">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Node Availability Graph</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Node Availability Graph</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/nodeAvailabilityGraph.js"></script>
