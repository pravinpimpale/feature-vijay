...
<title> Memory Threshold History Report | DataTables</title>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/nodeReport/memoryThresholdHistoryForm">Memory Threshold History
										Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Memory Threshold History Report</h3> &nbsp; &nbsp; &nbsp;<b>From Date :</b> ${fdate} <b>&nbsp; &nbsp; &nbsp;To Date :</b> ${tdate}
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<tbody>
											...
											<c:forEach var="report" items="${statusReportData}">
												<tr>
													...
													<td>${report.MEMORY_UTILIZATION}</td>
													<td>${report.MEMORY_THRESHOLD}</td>
													<td>${report.MEMORY_STATUS}</td>
