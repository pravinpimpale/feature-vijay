...
<c:choose>
	<c:when test="${userId==null}">
		<title>Add Node Parameter</title>
	</c:when>
	<c:otherwise>
...
<body class="hold-transition layout-top-nav">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<c:choose>
									<c:when test="${userId==null}">
										<li class="breadcrumb-item active">Add Node Parameter</li>
									</c:when>
									<c:otherwise>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<c:choose>
										<c:when test="${userId==null}">
											<h3 class="card-title">Add Node Parameter</h3>
										</c:when>
										<c:otherwise>
 ...
 --%>
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputPassword1">Memory threshold</label>
