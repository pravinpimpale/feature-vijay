...
<title>Device Alert Log | DataTables</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>View Device Alert Log</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">viewDeviceAlertLog</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Device Alert Log</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="emp" items="${deviceALertLog}">
												<tr>

													<td>${emp.NODE_IP}</td>
													<td>${emp.ALERT_ID}</td>
													<td>${emp.ALERT_MSG}</td>
													<td>${emp.ALERT_TIMESTAMP}</td>
