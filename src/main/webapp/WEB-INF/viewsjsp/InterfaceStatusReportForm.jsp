...
<html lang="en">
<head>
<title>Interface Status Report | DataTables</title>
<meta charset="utf-8">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Interface Status Report</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Interface Status Report</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="interfaceStatusReport">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
