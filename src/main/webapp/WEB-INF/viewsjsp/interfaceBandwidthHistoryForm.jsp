...
<html lang="en">
<head>
<title>Interface Bandwidth History Report | DataTables</title>
<meta charset="utf-8">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Interface Bandwidth History</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" action="interfaceBandwidthHistoryReport">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
