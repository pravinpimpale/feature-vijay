...
<html lang="en">
<head>
<title>Interface CRC History Report | DataTables</title>
<meta charset="utf-8">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/interfaceReport/interfaceCrcHistoryForm">Interface
										CRC History Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Interface CRC History Report</h3> &nbsp; &nbsp; &nbsp;<b>From Date :</b> ${fdate} <b>&nbsp; &nbsp; &nbsp;To Date :</b> ${tdate}
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<tbody>
											...
											<c:forEach var="report" items="${InterfaceReportData}">
												<tr>
													...
													<td>${report.OLD_CRC_VAL}</td>
													<td>${report.NEW_CRC_VAL}</td>
