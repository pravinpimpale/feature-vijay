...
<body class="hold-transition layout-top-nav">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form:form method="post" id="addServiceProviderId"
									modelAttribute="fetchSPInfo">
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputName">Service Provider Name</label>
													<form:input type="text" path="serviceProviderName"
														class="form-control"
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/addServiceProvider.js"></script>
