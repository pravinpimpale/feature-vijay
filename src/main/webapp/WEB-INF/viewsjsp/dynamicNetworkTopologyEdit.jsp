								...
								<div class="card-body">
									...
									<div id="templatemo_container">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div id="branchname" tabindex="3">
															<select class="form-control" id="fromIpAddress" name="fromIpAddress" onchange="showInterfaceNameFromIP();">
												...
												<div class="row" style="margin-top: 15px">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div id="branchname" tabindex="3">
																<select class="form-control" id="fromInterface" name="fromInterface">
										...
										<div>
											...
											<button type="submit" class="btn btn-info" onclick="getNodePositions()">Save Positions</button>
											<button type="submit" class="btn btn-info" onclick="addLink()">Add Link</button>
										</div>
