...
<title>Add Make And Model</title>
<link rel="stylesheet"
...
<body class="hold-transition layout-top-nav">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Add Make and Model</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">Add Make and Model</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Add Make and Model</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form:form method="post" id="addMakeModelId"
									modelAttribute="fetchMakeModelInfo">
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputName">Make and Model Name</label>
													<form:input type="text" path="makeModelName"
														class="form-control"
														placeholder="Enter Make and Model Name" />
												</div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Make and Model Details</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
	...
	<script src="<%=request.getContextPath()%>/custom_js/addMakeModel.js"></script>
