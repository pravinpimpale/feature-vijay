...
<html lang="en">
<head>
<title>Location Master Report | DataTables</title>
<meta charset="utf-8">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form:form method="post" id="locationMasterId"
									modelAttribute="locationMaster">
									<div class="card-body">
										...
										<div class="row">
												...
												<div class="form-group">
													...
													<form:select type="text" path="companyName"  class="form-control select2"
														style="width: 100%;"
														placeholder="Enter the Company name"  items="${companyOptions}"  />
												</div>
												<div class="form-group">
