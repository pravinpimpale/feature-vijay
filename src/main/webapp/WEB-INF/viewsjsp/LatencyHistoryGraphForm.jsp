...
<html lang="en">
<head>
<title>Latency History Graph | Graphs</title>
<meta charset="utf-8">
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/webtemplate/css/font-awesome.min.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/webtemplate/css/font-awesome.css">
</head>
...
<body class="hold-transition layout-top-nav">
	...
	<div class="wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Latency Graph</li>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Latency Historical Graph</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
		...
		<div class="card card-default" id="graphView" style="display: none">
			<div class="card-header">
				<h3 class="card-title">
					Latency Packet Drop Graph : <span
...
src="<%=request.getContextPath()%>/webtemplate/datatablesJS/jquery.dataTables.js"></script>-->
	...
	<script src="<%=request.getContextPath()%>/custom_js/latencyGraph.js"></script>
</body>
