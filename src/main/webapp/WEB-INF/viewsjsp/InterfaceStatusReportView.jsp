...
<title>Interface Status Report</title>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/interfaceReport/interfaceStatusReportForm">Interface
										Status Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Interface Status Report</h3> &nbsp; &nbsp; &nbsp;<b>From Date :</b> ${fdate} <b>&nbsp; &nbsp; &nbsp;To Date :</b> ${tdate}
								</div>
								<!-- /.card-header -->
								<div class="card-body">
