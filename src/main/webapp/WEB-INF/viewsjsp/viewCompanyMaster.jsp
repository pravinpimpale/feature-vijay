...
<title>View Company Master | DataTables</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>View Company Master</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">viewCompanyMaster</li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="emp" items="${viewCompanyMaster}">
												<tr>
													...
													<td><a href="editCompanyMaster/${emp.ID}">Edit</a></td>
													<td><a href="javascript:deleteCompanyMaster(${emp.ID})">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
