...
<title>Configuration Backup Data | DataTables</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Configuration Backup Data</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">View Configuration
									Backup</li>
							</ol>
						</div>
					</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">View Configuration Backup</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="emp" items="${configBackup}">
												<tr>

													<td>${emp.NODE_IP}</td>
													<td>${emp.BACKUP}</td>
													<td>${emp.BACKUP_PATH}</td>
													<td>${emp.GROUP_NAME}</td>
													<td>${emp.RUNNING_CONFIG}</td>
													<td>${emp.STARTUP_CONFIG}</td>
													<td>${emp.TIME}</td>
													
													<td><a href="editConfigBackup/${emp.ID}">Edit</a></td>
													<td><a href="javascript:deleteConfigBackupdata(${emp.ID})">Delete</a></td>
