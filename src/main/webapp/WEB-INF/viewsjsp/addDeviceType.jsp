...
<body class="hold-transition layout-top-nav">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Add Device Type</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Add Device Type</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form:form method="post" id="addDeviceTypeId"
									modelAttribute="fetchDeviceTypeInfo">
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputName">Device Type</label>
													<form:input type="text" path="deviceTypeName"
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Device Type Details</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
	...
	<script src="<%=request.getContextPath()%>/custom_js/addDeviceType.js"></script>
