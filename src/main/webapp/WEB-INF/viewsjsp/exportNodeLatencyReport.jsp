...
<title>Node Latency Report | DataTables</title>
...
<body class="hold-transition layout-top-nav">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>View Node Latency Report</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">nodeLatencyReport</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Node Latency report</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">


									<table id="exportNodeLatencyTable"
										...
										<tbody>
											<c:forEach var="emp" items="${data}">
												<tr>
													...
													<td>${emp.NODE_IP}</td>
													<td>${emp.AVG_LATENCY}</td>
													<td>${emp.MAX_LATENCY}</td>
													<td>${emp.MIN_LATENCY}</td>
													<td>${emp.PACKET_LOSS}</td>
	...
	<script>
		$(function() {
			$("#exportNodeLatencyTable").DataTable(
					{
						/* "responsive" : true, */
						"scrollX" : true,
						"lengthChange" : false,
					...
					'exportNodeLatencyTable_wrapper .col-md-6:eq(0)');
			$('#example2').DataTable({
				"paging" : true,
				"lengthChange" : false,
				"searching" : false,
