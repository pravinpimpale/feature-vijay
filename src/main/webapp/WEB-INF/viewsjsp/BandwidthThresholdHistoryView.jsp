...
<html lang="en">
<head>
<title>BW Threshold History Report | DataTables</title>
<meta charset="utf-8">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/interfaceReport/interfaceStatusReportForm">Bandwidth Threshold History Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Bandwidth Threshold History Report</h3> &nbsp; &nbsp; &nbsp;<b>From Date :</b> ${fdate} <b>&nbsp; &nbsp; &nbsp;To Date :</b> ${tdate}
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											<c:forEach var="report" items="${InterfaceReportData}">
												<tr>
													<td>${report.ID}</td>
													
													<td>${report.INTERFACE_NAME}</td>
													<td>${report.BW_THRESHOLD}</td>
													<td>${report.BW_VAL}</td>
													<td>${report.BW_STATUS}</td>
													<td>${report.IP_INTERFACE}</td>
