...
<title>View Location | DataTables</title>
...
<body class="hold-transition layout-top-nav">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>View Location Master</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">viewLocationMaster</li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="emp" items="${viewLocationMaster}">
												<tr>
													...
													<td><a href="editLocationMaster/${emp.ID}">Edit</a></td>
													<td><a href="javascript:deleteLocationMaster(${emp.ID})">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
	...
	<script src="<%=request.getContextPath()%>/custom_js/locationMaster.js"></script>
