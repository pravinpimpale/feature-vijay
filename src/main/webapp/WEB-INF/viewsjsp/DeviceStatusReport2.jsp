...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="<%=request.getContextPath()%>/webtemplate/index3.html"
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img
									src="<%=request.getContextPath()%>/webtemplate/dist/img/user1-128x128.jpg"
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img
									src="<%=request.getContextPath()%>/webtemplate/dist/img/user8-128x128.jpg"
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img
									src="<%=request.getContextPath()%>/webtemplate/dist/img/user3-128x128.jpg"
									alt="User Avatar" class="img-size-50 img-circle mr-3">
								<div class="media-body">
									<h3 class="dropdown-item-title">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="<%=request.getContextPath()%>/webtemplate/index3.html"
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img
							src="<%=request.getContextPath()%>/webtemplate/dist/img/user2-160x160.jpg"
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="<%=request.getContextPath()%>/webtemplate/index.html"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Dashboard v1</p>
								</a></li>
								<li class="nav-item"><a
									href="<%=request.getContextPath()%>/webtemplate/index2.html"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Dashboard v2</p>
								</a></li>
								<li class="nav-item"><a
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a
									href="../layout/fixed-sidebar-custom.html" class="nav-link">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="#" class="nav-link"> <i
									...
									<ul class="nav nav-treeview">
										...
										<li class="nav-item"><a
											href="../examples/forgot-password.html" class="nav-link">
												<i class="far fa-circle nav-icon"></i>
								...
								<li class="nav-item"><a
									href="<%=request.getContextPath()%>/webtemplate/starter.html"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Starter Page</p>
								</a></li>
							</ul></li>
						...
						<li class="nav-item"><a
							href="<%=request.getContextPath()%>/webtemplate/iframe.html"
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<c:choose>
									<c:when test="${userId==null}">
										<li class="breadcrumb-item active">Device Status Report</li>
									</c:when>
									<c:otherwise>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<c:choose>
										<c:when test="${userId==null}">
											<h3 class="card-title">Device Status Report</h3>
										</c:when>
										<c:otherwise>
								...
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form method="post" id="companyMasterId">
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<form:select name="group_name" type="text" path="groupName"
