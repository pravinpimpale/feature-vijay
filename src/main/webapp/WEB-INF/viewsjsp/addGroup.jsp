...
<body class="hold-transition layout-top-nav">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form:form method="post" id="addGroupId"
									modelAttribute="fetchGroupInfo">
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputName">Group Name</label>
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<!-- 	<c:forEach var="group" items="${groupData}">
												<tr>
													...
													<td><a href="javascript:deleteUser(${group.ID})">Delete</a></td>
												</tr>
											</c:forEach> -->
	...
	<script src="<%=request.getContextPath()%>/custom_js/addGroup.js"></script>
