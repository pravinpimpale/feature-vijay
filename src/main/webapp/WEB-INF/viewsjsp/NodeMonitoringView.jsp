...
<title>Node Monitoring Report | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">NodeMonitoring</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Node Monitoring</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<tbody>
											<c:forEach var="emp" items="${node}">
												<tr>
													...
													<td>${emp.NODE_IP}</td>
													<td>${emp.NODE_STATUS}</td>
													<td>${emp.STATUS_TIMESTAMP}</td>
													<td>${emp.LATENCY}</td>
													<td>${emp.LATENCY_STATUS}</td>
													<td>${emp.LATENCY_THRESHOLD}</td>
													<td>${emp.LATENCY_TIMESTAMP}</td>
