						...
						<div class="col-12">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<button class="btn btn-secondary buttons-copy buttons-html5" type="button" id="importNodeIP"><span>Import</span></button>
										...
										<tbody>
											<c:forEach var="emp" items="${discoveredNetwork}">
												<tr>
													...
													<td><input type="checkbox" id="selectNodeIP" value="${emp.NODE_IP}" name="selectNodeIP" style="margin-right: 10px">${emp.NODE_IP}</td>
													<td>${emp.NODE_NAME}</td>
													<td>${emp.MAC_ID}</td>
													<td>${emp.OEM}</td>
													<td>${emp.OS_TYPE}</td>
