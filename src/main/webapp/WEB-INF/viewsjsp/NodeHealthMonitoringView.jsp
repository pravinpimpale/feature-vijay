...
<title>Node Health Monitoring Report | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">NodeHealthMonitoring</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Node Health Monitoring</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<tbody>
											<c:forEach var="emp" items="${node}">
												<tr>
													...
													<td>${emp.NODE_IP}</td>
													<td>${emp.NODE_NAME}</td>
													<td>${emp.MAKE_AND_MODEL}</td>
													<td>${emp.VERSION}</td>
													<td>${emp.SERIAL_NO}</td>
													<td>${emp.UPTIME}</td>
													<td>${emp.CPU_UTILIZATION}</td>
													<td>${emp.CPU_STATUS}</td>
													<td>${emp.MEMORY_UTILIZATION}</td>
													<td>${emp.MEMORY_STATUS}</td>
													<td>${emp.TOTAL_MEMORY}</td>
													<td>${emp.USED_MEMORY}</td>
													<td>${emp.FREE_MEMORY}</td>
