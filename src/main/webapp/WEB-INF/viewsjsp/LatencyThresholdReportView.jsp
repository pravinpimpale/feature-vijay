...
<title> Latency Threshold Report | DataTables</title>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/nodeReport/latencyThresholdReportForm">Latency Threshold
										Report</a></li>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Latency Threshold History Report</h3> &nbsp; &nbsp; &nbsp;<b>From Date :</b> ${fdate} <b>&nbsp; &nbsp; &nbsp;To Date :</b> ${tdate}
								</div>
								<!-- /.card-header -->
								<div class="card-body">
										...
										<tbody>
											...
											<c:forEach var="report" items="${statusReportData}">
												<tr>
													...
													<td>${report.LATENCY_THRESHOLD}</td>
													<td>${report.LATENCY_VAL}</td>
													<td>${report.LATENCY_STATUS}</td>
