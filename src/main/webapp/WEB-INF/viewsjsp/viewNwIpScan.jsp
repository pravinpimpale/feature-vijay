...
<title>View IP Scan | DataTables</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">viewIPSCAN</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">View IP SCAN</h3>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="emp" items="${viewIpScan}">
												<tr>
													...
													<td><a href="editIpScan/${emp.ID}">Edit</a></td>
													<td><a href="javascript:deleteIpScan(${emp.ID})">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
