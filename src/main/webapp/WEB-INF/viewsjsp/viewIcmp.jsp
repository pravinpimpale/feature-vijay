...
<title>View ICMP Configurations | DataTables</title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>View ICMP Configuration</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">viewIcmp</li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<c:forEach var="emp" items="${icmpConfig}">
												<tr>

													<td>${emp.PACKET_SIZE}</td>
													<td>${emp.PACKET_COUNT}</td>
													<td>${emp.POOLING_TIME}</td>
													<td>${emp.TIMEOUT}</td>
													<td>${emp.TTL}</td>
													...
													<td><a href="editIcmp/${emp.ID}">Edit</a></td>
													<td><a href="javascript:deleteIcmp(${emp.ID})">Delete</a></td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
