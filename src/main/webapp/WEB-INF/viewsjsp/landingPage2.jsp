...
<body
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						...
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img
									src="<%=request.getContextPath()%>/webtemplatedist/img/user3-128x128.jpg"
									alt="User Avatar" class="img-size-50 img-circle mr-3">
								<div class="media-body">
									<h3 class="dropdown-item-title">
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a
									...
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>ICMP Configuration</p>
								</a></li>
								<li class="nav-item"><a
									href="<%=request.getContextPath()%>/master/viewIcmp"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>View ICMP Configuration</p>
								</a></li>
								<li class="nav-item"><a
									...
									<ul class="nav nav-pills flex-column">
										<li class="nav-item"><a href="#" class="nav-link">
												...
												class="float-right text-danger"> <i
													class="fas fa-arrow-down text-sm"></i> 12%
											</span>
										</a></li>
										<li class="nav-item"><a href="#" class="nav-link">
	...
	<script
		src="<%=request.getContextPath()%>/webtemplate/dist/js/pages/dashboard2.js"></script>
</body>
</html>
