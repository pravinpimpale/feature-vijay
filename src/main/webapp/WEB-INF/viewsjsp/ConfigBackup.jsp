						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Configuration Backup</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<!--<form id="quickForm">-->

								<form method="post" id="configBackup">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-check">
													<input class="form-check-input" type="checkbox" id="runConfig" checked>
													<label class="form-check-label">Running
														Configuration</label>
												</div>
												<div class="form-check">
													<input class="form-check-input" type="checkbox" id="startupConfig"> <label
														class="form-check-label">Startup Configuration</label>
												</div>
												<br>
													...
													<div class="form-group">
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" id="radio1"
																name="radio1" value="Daily Backup"> <label class="form-check-label">Daily
																Backup</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" id="radio1"
																name="radio1" value="Weekly Backup" checked> <label
																class="form-check-label">Weekly Backup</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" id="radio1"
																name="radio1" value="Montly Backup"> <label class="form-check-label">Monthly
																Backup</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" id="radio1"
																name="radio1" value="Plan Backup"> <label class="form-check-label">Plan
																Backup</label>
														</div>
