...
//	alert("Hi");
	//Add Group Listing 
	  ...
	  var l = window.location;
	  	...
	  	var serviceUrl = base_url + "/master/groupListing";
	     $.ajax({
	         type: 'GET',
	         url: serviceUrl,
	         dataType: 'json',
...
//alert("DeleteGroup Called");
	...
	var l = window.location;
	var base_url = l.protocol + "//" + l.host + "/" + l.pathname.split('/')[1];
	var serviceUrl = base_url + "/master/deleteGroup";
	$.ajax({
		type : 'POST',
		url : serviceUrl,
		data : 'id=' + id,
		...
		if (data === "success") {
			...
			Swal.fire({
				...
				timer : 3000
				 ...
				 var l = window.location;
				   var base_url = l.protocol + "//" + l.host + "/" + l.pathname.split('/')[1];
				  window.location.href =base_url+"/master/addGroupForm";
...
function addGroup()
{
	 var l = window.location;
		var base_url = l.protocol + "//" + l.host + "/"
				+ l.pathname.split('/')[1];
		var serviceUrl = base_url + "/master/addGroup";
	  $.ajax({
	        type: 'POST',
	        url: serviceUrl,
