...
function generateGraph()
{
    ...
    $.ajax({
        type: 'POST',
        url: 'interfaceAvailabilityGraph',
        dataType: 'json',
...
// alert("downtimePercent:"+jsondata.downtimePercent);
 // alert("uptimePercent:"+jsondata.uptimePercent);
            var start = +new Date();
            // Create the chart
            ...
            Highcharts.stockChart('containervlx', {
                chart: {
                    events: {
                        load: function () {
                            this.setTitle(null, {
                                text: 'Availablity#' + (new Date() - start) + 'ms'
...
//                            },
                ...
                subtitle: {
                    text: 'Availablity' // dummy text to reserve space for dynamic subtitle
                },
                series: [
                    {
